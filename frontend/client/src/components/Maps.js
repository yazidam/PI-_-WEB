      ...
      axios.get(`http://localhost:4000/delivery/all/from`).then((res) => {
        ...
        axios.get(`http://localhost:4000/delivery/all/to`).then((res) => {
          ...
          this.state.list.map((l) => {
            axios
              .get(
                `https://geocode.search.hereapi.com/v1/geocode?q=${l.from}&apiKey=6wA6ZCd7sLO1w44m-rupLpiT3NKeuLqfm29mEnHy5UI`
              )
              .then((res, err) => {
                this.setState({
                  posfrom: res.data.items[0].position.lat,
          ...
          this.state.listto.map((t) => {
            axios
              .get(
                `https://geocode.search.hereapi.com/v1/geocode?q=${t.to}&apiKey=6wA6ZCd7sLO1w44m-rupLpiT3NKeuLqfm29mEnHy5UI`
              )
              .then((res, err) => {
                this.setState({
                  posto: res.data.items[0].position.lat,
